    ...
    public function reset_password_request(Request $request)
    {
        ...
        try 
        {
           ...
           if (!$driver) 
           {
            ...
            // Security checks
            $count = PasswordReset::where('email', $driver->email)->where('created_at', '>=', \Carbon\Carbon::now()->subHour())->count();
            ...
            $count =PasswordReset:: where('email', $driver->email)->where('created_at', '>=', Carbon::today())->count();
            ...
            Mail::to($driver->email)->send(new \App\Mail\PasswordResetMail($token));
